...
cd ../..
cd bionic
git apply -v ../device/LeEco/X3/patches/bionic/bionic.patch
cd ..
cd frameworks/av
git apply -v ../../device/LeEco/X3/patches/frameworks/av/frameworks_av.patch
cd ../..
cd system/core
git apply -v ../../device/LeEco/X3/patches/system/core/system_core.patch
cd ../..
